...
Some example lines of parsed {\tt .csv} files is shown in the table below, the {\tt bb\_cc} field is removed as it containing binary data.
...
%TODO final results and stuff.
%You need an additional section after this describing the final cleaning process. Summarize the time for each step. Report the number of fish removed by FEIF and the SVM stages, and how many remain. Give percentages as well.
%Also show 5-10 examples of TP, FP, FN results from the 1000 frame random validation set.
